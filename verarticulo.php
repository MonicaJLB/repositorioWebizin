...
<h2 style="text-align: center;"><b><?php echo $titulo;?></b></h2>
        ...
        <div class="col-1">
            ...
            <div class="col-10">
                ...
                <textarea name="com" id="comentario" onclick="texto();" class="form-control" rows="5" cols="5"" readonly><?php echo $comentario;?></textarea>
                <br>
                <input type="button" onclick="comentar();" value="Comentar Artículo" />
        ...
        function comentar(){
          if(texto()){
            ...
            if(coment.length <255 && coment != ""){
                <?php
                    $sqlComentar = "INSERT INTO comentarios(id_articulo,id_usuario,comentario) VALUES ('$id','$_SESSION[]','coment')";  
                ?>
            }
            else{
              alert("has un comentario mas pequeño");
            }
          }else{
            alert("inicia sesion para comentar");
          }
